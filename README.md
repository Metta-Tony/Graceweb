...
This is a simple static 3-page site for a golf event: Home, Event Details & Registration (email-based), and Donate (charity). Betting content has been removed; any event-day wagering is handled at the venue if offered.

Files added:
- `index.html` — Home / hero / CTAs
- `event.html` — Event details, schedule, course info, registration instructions (mailto link)
- `donate.html` — Charity & donation options
